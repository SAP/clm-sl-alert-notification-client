...
public class AlertNotificationConfigurationClientBuilderTest {
    ...
    @Test
    public void givenThatOAuthWithCertificateIsUsedForAuthentication_whenBuildIsCalled_thenCorrectClientIsBuilt() {
        AlertNotificationConfigurationClient alertNotificationConfigurationClient = (AlertNotificationConfigurationClient) classUnderTest //
                .withHttpClient(TEST_HTTP_CLIENT) //
                .withRetryPolicy(TEST_RETRY_POLICY) //
                .withServiceRegion(TEST_SERVICE_REGION)
                .withAuthentication(TEST_CERTIFICATE, TEST_PRIVATE_KEY, TEST_OAUTH_SERVICE_URI, TEST_CLIENT_ID) //
                .build();
    ...
    @Test
    public void givenThatOAuthWithCertificateIsUsedForAuthentication_whenBuildFromServiceBindingIsCalled_thenCorrectClientIsBuilt() {
        AlertNotificationConfigurationClient alertNotificationConfigurationClient = (AlertNotificationConfigurationClient) classUnderTest //
                .withHttpClient(TEST_HTTP_CLIENT) //
                .withRetryPolicy(TEST_RETRY_POLICY) //
                .withAuthentication(TEST_CERTIFICATE, TEST_PRIVATE_KEY, TEST_OAUTH_SERVICE_URI, TEST_CLIENT_ID)
