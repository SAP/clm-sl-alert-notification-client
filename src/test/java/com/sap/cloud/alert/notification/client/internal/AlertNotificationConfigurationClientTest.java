...
public class AlertNotificationConfigurationClientTest {
    ...
    private static final Action TEST_ACTION = new Action(null, TEST_TYPE, TEST_NAME, TEST_STATE, TEST_DESCRIPTION, TEST_LABELS, TEST_DISCARD_AFTER, TEST_FALLBACK_TIME, TEST_FALLBACK_ACTION,
            TEST_ENABLE_DELIVERY_STATUS, TEST_PROPERTIES, null, null);
